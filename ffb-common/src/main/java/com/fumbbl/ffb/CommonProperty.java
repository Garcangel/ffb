...
public enum CommonProperty {
	...
	SETTING_MARK_BLITZING_PLAYER("setting.mark.blitzing.player", "Mark blitzing player", "Gameplay"),
	...
	SETTING_DYNAMIC_PITCH_SCALING("setting.dynamicPitchScaling", "Dynamic Pitch Scaling", "Configuration"),
	...
	public static final CommonProperty[] _SAVED_USER_SETTINGS = {SETTING_SOUND_MODE, SETTING_UI_LAYOUT,
		...
		SETTING_MARK_BLITZING_PLAYER, SETTING_PLAYER_MARKING_TYPE, SETTING_SHOW_AUTO_MARKING_DIALOG, SETTING_SWAP_TEAM_COLORS,
		...
		SETTING_SCALE_FACTOR, SETTING_DYNAMIC_PITCH_SCALING, SETTING_LOCAL_SETTINGS, SETTING_SHOW_CRATERS_AND_BLOODSPOTS, SETTING_SWEET_SPOT,
